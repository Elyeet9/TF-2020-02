...
public:
	CJuego(System::Drawing::Rectangle area_dibujo) {
		...
		corrupt = gcnew CEntidad("img\\corrupt.png", System::Drawing::Rectangle(600, 300, 100, 120), 4, 4, 1);
		assassin = gcnew CEntidad("img\\assassin.png", System::Drawing::Rectangle(600, 700, 100, 120), 4, 4, 1);
