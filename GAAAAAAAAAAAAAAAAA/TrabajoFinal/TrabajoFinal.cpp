/*
Este juego ha sido realizado por el team Vida
Compartir este codigo esta en contra de las normas, si lo haces eri gei
Dale like favoritos compartir a nuestros yutu
[poner links]
*/
#include "pch.h"
#include "MyForm.h"
