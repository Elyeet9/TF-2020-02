...
ref class CArregloAliados
{
    ...
    short cont;
public:
    CArregloAliados(String^ ruta, short n, short w, short h, Laberinto^ laberinto, short reyX, short reyY) : cont(2) {//la clase usa/depende de la clase laberinto
        ...
        this->aliados->Add(gcnew CAliado(imagen, area, 4, 4, laberinto, reyX, reyY));
        this->aliados->Add(gcnew CAliado(imagen, area, 4, 4, laberinto, reyX, reyY));
